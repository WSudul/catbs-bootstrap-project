...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatbsRestApi.ClientRegistration();
  });
  ...
  describe('ClientRegistration', function() {
    it('should create an instance of ClientRegistration', function() {
      // uncomment below and update the code to test ClientRegistration
      //var instane = new CatbsRestApi.ClientRegistration();
      //expect(instance).to.be.a(CatbsRestApi.ClientRegistration);
    });
